...
class TestRadioInputField(object):
    ...
    def test_render_label_wrapped_left(self):
        ...
        field_with_multiple_values = fields.Radio(
            name='test', label='My Radio Group', values=(('Test', 1), ('Testing', 2)))
        assert str(
    ...
    def test_checked_value(self):
        field = fields.Radio(
            name='test', label='My Radio Group', values=(('Test', 1), ('Testing', 2)), value=2)
        assert str(
...
class TestSelectField(object):
    ...
    def test_render_options_list(self):
        ...
        field_with_value = fields.Select(
            name='test', options=[1, 2, 3], value=2)
        assert str(
        ...
        field_with_key_value = fields.Select(
            name='test', options=[(1, 'Test'), (2, 'Testing')])
        assert str(
    ...
    def test_optgroup(self):
        ...
        field_with_key_value = fields.Select(name='test', options=collections.OrderedDict(
            [('Group One', [(1, 'Test'), (2, 'Testing')]), ('Group Two', [3, 4])]))
        assert str(
